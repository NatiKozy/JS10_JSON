...
function makeTwo() {
	localStorage.setItem('two', "7,6,5");
...
function makeThree() {
	localStorage.setItem('three', "name=John, age=25");
...
const showCart = () => {
	...
	document.querySelector('.practicum23').innerHTML = cartItems;
};
...
const setCookie = (name, value) => {
	...
	console.log('cookie установлены');
};
